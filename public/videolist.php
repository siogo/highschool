...
<body>
	    ...
	    <div class="sec">
			...
			<nav class="link">
			    <ul class="o-nav">
				    ...
				    <li class="active"><a href="paragraph.php?page=1" class="w-bc">文章赏析</a></li>
    ...
    <div id="content" style="width:998px;border:1px solid #999;height:530px;padding:0">	
	    <div class="wk zylb" style="background:#fff;">
		    <div class="wz">
			    <a href="javascript:void(0);">当前位置</a>:<a href="javascript:void(0);">全部视频</a>
			</div>
		    <div class="return">
			...
			<div class="ssym">
			    ...
			    <a id="prev" href="videolist.php">上一页</a>
					当前第<span><?php  echo $page; ?></span>页，共<span id="ispan"><?php echo $pages; ?></span>页
				<a id="next" href="videolist.php">下一页</a>
			</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#prev').attr('href','videolist.php?page='+prev);	
		$('#next').attr('href','videolist.php?page='+next);

		var div = $('.bt');
		for (var i = 0; i < div.length; i++) {
			var pid = $(div[i]).find('span').text();
			$(div[i]).find('a').attr('href','videoplay.php?vid='+pid);
		};
